...
careless_ids <- c(
  "ma_se_2005_11_14_490", "reve20041021036", "di_ma_2005_10_20_756",
  "pa_sc_2005_09_10_468", "il_re_2006_01_18_645", "so_ma_2003_10_13_804",
  "lo_ca_2005_05_07_05_437", "va_ma_2005_05_31_567", "no_un_2005_06_29_880",
  "an_bo_1988_08_24_166", "st_ma_2004_04_21_426", "an_st_2005_10_16_052",
  "vi_de_2002_12_30_067", "gi_ru_2005_03_08_033", "al_mi_2005_03_05_844",
  "la_ma_2006_01_31_787", "gi_lo_2004_06_27_237", "ch_bi_2001_01_28_407",
  "al_pe_2001_04_20_079", "le_de_2003_09_05_067", "fe_gr_2002_02_19_434",
  "ma_ba_2002_09_09_052", "ca_gi_2003_09_16_737", "an_to_2003_08_06_114",
  "al_se_2003_07_28_277", "ja_tr_2002_10_06_487", "el_ci_2002_02_15_057",
  "se_ti_2000_03_04_975", "co_ga_2003_10_29_614", "al_ba_2003_18_07_905",
  "bi_ro_2003_09_07_934", "an_va_2004_04_08_527", "ev_cr_2003_01_27_573"
)
...
if ("n_ema" %in% names(dat_raw)) {
  ...
  n_ema_tbl <- dat_raw %>%
    ...
    dplyr::summarise(n_ema = as.integer(sum(.is_ema, na.rm = TRUE)), .groups = "drop")
}
if (!"n_ema" %in% names(dat_raw)) {
...
meta_df <- suppressMessages(rio::import(META_PATH)) %>%
  ...
  dplyr::mutate(
    ...
    course = dplyr::case_when(
      stringr::str_detect(course, regex("^psico", ignore_case = TRUE)) ~ "Psicometria",
      stringr::str_detect(course, regex("^test", ignore_case = TRUE)) ~ "Testing",
      stringr::str_detect(course, regex("^inter", ignore_case = TRUE)) ~ "Interventi",
      stringr::str_detect(course, regex("^clin", ignore_case = TRUE)) ~ "Clinica",
      TRUE ~ course
    ),
    sex = dplyr::case_when(
...
as_item_to_1_7 <- function(x) {
  ...
  if (is.finite(xmin) && is.finite(xmax) && xmin >= 0 && xmax <= 100) {
    ...
    return(as.integer(findInterval(x, brk, rightmost.closed = TRUE, all.inside = TRUE)))
  }
...
qa_lines <- c(
  ...
  sprintf("Esclusi step1 (careless + n_ema out of [5,40]): %d",
...
qa_lines <- c(
  qa_lines,
  sprintf("n_ema (included) — min: %d, q1: %d, median: %d, mean: %.2f, q3: %d, max: %d",
...
message(
  "\nPulizia completata.\n",
  "- Dataset: ", OUT_CLEAN_CSV, " | ", OUT_CLEAN_RDS, "\n",
  "- SAMPLE: N = ", n_final, " FEMALE students\n",
  "- Log esclusioni: ", OUT_LOG_EXCL, "\n",
  "- QA: ", OUT_QA_TXT
)
