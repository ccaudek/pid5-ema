...
# ------------------------------------------------------------------------------
# Model 1: F0 Mean (vowel /i/) ~ (Stress Contrasts) × PID-5 (all 5)
# ------------------------------------------------------------------------------

cat("Fitting: F0 Mean (/i/) moderation model...\n")

formula_f0mean_mod_i <- bf(
  f0_mean_i ~
    c1_stress *
...
pp_check(m1_f0mean_mod_i)
summary(m1_f0mean_mod_i)

bayes_R2(m1_f0mean_mod_i)

# ------------------------------------------------------------------------------
# Model 2: F0 SD (vowel /i/) ~ (Stress Contrasts) × PID-5 (all 5)
# ------------------------------------------------------------------------------

cat("Fitting: F0 SD (/i/) moderation model...\n")

formula_f0std_mod_i <- bf(
  f0_std_i ~
    c1_stress *
      (pid5_negative_affectivity_bl_c +
        pid5_detachment_bl_c +
...
pp_check(m2_f0std_mod_i)
summary(m2_f0std_mod_i)
